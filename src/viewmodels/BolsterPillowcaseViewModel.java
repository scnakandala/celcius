...
public class BolsterPillowcaseViewModel extends AbstractViewModel{
    //inpputs
    ...
    private Double customDiameter = 0.0;
    ...
    private Double zipperVelcoCost = 0.0;
    private boolean useZipper = false;
    ...
    public Double getZipperVelcoCost() {
        return zipperVelcoCost;
    }

    public void setZipperVelcoCost(Double zipperVelcoCost) {
        this.zipperVelcoCost = zipperVelcoCost;
    }

    public boolean isUseZipper() {
        return useZipper;
    }

    public void setUseZipper(boolean useZipper) {
        this.useZipper = useZipper;
    }
