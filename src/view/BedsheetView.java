 ...
 * BedsheetView.java
 *
 * Created on Apr 10, 2013, 10:45:15 PM
 */
 ...
 * @author naka
 */
public class BedsheetView extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT b FROM Bedsheets b");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                BedsheetView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                BedsheetView.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                BedsheetView.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                BedsheetView.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<entities.Bedsheets> toRemove = new ArrayList<entities.Bedsheets>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            entities.Bedsheets b = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(b);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        entities.Bedsheets b = new entities.Bedsheets();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.Bedsheets> merged = new ArrayList<entities.Bedsheets>(list.size());
            for (entities.Bedsheets b : list) {
    ...
    private java.util.List<entities.Bedsheets> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new BedsheetView());
