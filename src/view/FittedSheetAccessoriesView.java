 ...
 * @author naka
 */
public class FittedSheetAccessoriesView extends JPanel {
    
    public FittedSheetAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT f FROM FittedsheetAccessories f");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                FittedSheetAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FittedSheetAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.FittedsheetAccessories> merged = new ArrayList<entities.FittedsheetAccessories>(list.size());
            for (entities.FittedsheetAccessories f : list) {
    ...
    private java.util.List<entities.FittedsheetAccessories> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FittedSheetAccessoriesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FittedSheetAccessoriesView());
