 ...
 * @author naka
 */
public class BolsterPillowcasesAccessoriesView extends JPanel {
    
    public BolsterPillowcasesAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT b FROM BolsterpillowcaseAccessories b");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                BolsterPillowcasesAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                BolsterPillowcasesAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.BolsterpillowcaseAccessories> merged = new ArrayList<entities.BolsterpillowcaseAccessories>(list.size());
            for (entities.BolsterpillowcaseAccessories b : list) {
    ...
    private java.util.List<entities.BolsterpillowcaseAccessories> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BolsterPillowcasesAccessoriesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new BolsterPillowcasesAccessoriesView());
