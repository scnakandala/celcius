 ...
 * @author naka
 */
public class BolsterPillowcasesView extends JPanel {
    
    public BolsterPillowcasesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT b FROM Bolsterpillowcases b");
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.size}"), sizeField, org.jdesktop.beansbinding.BeanProperty.create("text"));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(sizeField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                                    .addComponent(smvField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)))
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                BolsterPillowcasesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                BolsterPillowcasesView.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                BolsterPillowcasesView.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                BolsterPillowcasesView.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<entities.Bolsterpillowcases> toRemove = new ArrayList<entities.Bolsterpillowcases>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            entities.Bolsterpillowcases b = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(b);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        entities.Bolsterpillowcases b = new entities.Bolsterpillowcases();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.Bolsterpillowcases> merged = new ArrayList<entities.Bolsterpillowcases>(list.size());
            for (entities.Bolsterpillowcases b : list) {
    ...
    private java.util.List<entities.Bolsterpillowcases> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BolsterPillowcasesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new BolsterPillowcasesView());
