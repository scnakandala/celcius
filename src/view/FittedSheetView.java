 ...
 * @author naka
 */
public class FittedSheetView extends JPanel {
    
    public FittedSheetView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT f FROM Fittedsheet f");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                FittedSheetView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                FittedSheetView.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                FittedSheetView.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                FittedSheetView.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.Fittedsheet> merged = new ArrayList<entities.Fittedsheet>(list.size());
            for (entities.Fittedsheet f : list) {
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        entities.Fittedsheet f = new entities.Fittedsheet();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<entities.Fittedsheet> toRemove = new ArrayList<entities.Fittedsheet>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            entities.Fittedsheet f = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(f);
    ...
    private java.util.List<entities.Fittedsheet> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FittedSheetView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new FittedSheetView());
