...
/*
 * DuvetAccessoriesView.java
 *
 * Created on Apr 11, 2013, 12:35:20 PM
 */
 ...
 * @author naka
 */
public class DuvetAccessoriesView extends JPanel {
    
    public DuvetAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT d FROM DuvetAccessories d");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                DuvetAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                DuvetAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.DuvetAccessories> merged = new ArrayList<entities.DuvetAccessories>(list.size());
            for (entities.DuvetAccessories d : list) {
    ...
    private java.util.List<entities.DuvetAccessories> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new DuvetAccessoriesView());
