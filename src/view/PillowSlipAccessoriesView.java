 ...
 * @author naka
 */
public class PillowSlipAccessoriesView extends JPanel {
    
    public PillowSlipAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT p FROM PillowslipAccessories p");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                PillowSlipAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                PillowSlipAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.PillowslipAccessories> merged = new ArrayList<entities.PillowslipAccessories>(list.size());
            for (entities.PillowslipAccessories p : list) {
    ...
    private java.util.List<entities.PillowslipAccessories> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PillowSlipAccessoriesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new PillowSlipAccessoriesView());
