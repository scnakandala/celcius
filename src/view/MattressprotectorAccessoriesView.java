...
/*
 * MattressprotectorAccessoriesView.java
 *
 * Created on Apr 11, 2013, 1:51:34 PM
 */
 ...
 * @author naka
 */
public class MattressprotectorAccessoriesView extends JPanel {
    
    public MattressprotectorAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT m FROM MattresprotectorAccessories m");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                MattressprotectorAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                MattressprotectorAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.MattresprotectorAccessories> merged = new ArrayList<entities.MattresprotectorAccessories>(list.size());
            for (entities.MattresprotectorAccessories m : list) {
    ...
    private java.util.List<entities.MattresprotectorAccessories> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new MattressprotectorAccessoriesView());
