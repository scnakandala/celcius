...
/*
 * BolsterAccessoriesView.java
 *
 * Created on Apr 23, 2013, 1:38:55 PM
 */
 ...
 * @author naka
 */
public class BolsterAccessoriesView extends JPanel {
    
    public BolsterAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT b FROM BolsterAccessories b");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                BolsterAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                BolsterAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.BolsterAccessories> merged = new ArrayList<entities.BolsterAccessories>(list.size());
            for (entities.BolsterAccessories b : list) {
    ...
    private java.util.List<entities.BolsterAccessories> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new BolsterAccessoriesView());
