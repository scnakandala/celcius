...
/*
 * DuvetcoverAccessoriesView.java
 *
 * Created on Apr 11, 2013, 1:21:57 PM
 */
 ...
 * @author naka
 */
public class DuvetcoverAccessoriesView extends JPanel {
    
    public DuvetcoverAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT d FROM DuvetcoverAccessories d");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                DuvetcoverAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                DuvetcoverAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.DuvetcoverAccessories> merged = new ArrayList<entities.DuvetcoverAccessories>(list.size());
            for (entities.DuvetcoverAccessories d : list) {
    ...
    private java.util.List<entities.DuvetcoverAccessories> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new DuvetcoverAccessoriesView());
