...
/*
 * CotsheetAccessoriesView.java
 *
 * Created on Apr 10, 2013, 11:39:00 PM
 */
 ...
 * @author naka
 */
public class CotsheetAccessoriesView extends JPanel {
    
    public CotsheetAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM CotsheetAccessories c");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                CotsheetAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                CotsheetAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.CotsheetAccessories> merged = new ArrayList<entities.CotsheetAccessories>(list.size());
            for (entities.CotsheetAccessories c : list) {
    ...
    private java.util.List<entities.CotsheetAccessories> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new CotsheetAccessoriesView());
