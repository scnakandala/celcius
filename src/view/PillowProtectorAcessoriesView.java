 ...
 * @author naka
 */
public class PillowProtectorAcessoriesView extends JPanel {
    
    public PillowProtectorAcessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT p FROM PillowprotectorAccessories p");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                PillowProtectorAcessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                PillowProtectorAcessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.PillowprotectorAccessories> merged = new ArrayList<entities.PillowprotectorAccessories>(list.size());
            for (entities.PillowprotectorAccessories p : list) {
    ...
    private java.util.List<entities.PillowprotectorAccessories> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PillowProtectorAcessoriesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new PillowProtectorAcessoriesView());
