 ...
 * @author naka
 */
public class ComfortersCostingPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel120.setText("Comforters Costing");

        jLabel152.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jLabel152.setText("Select Comforter Type:");
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new ComfortersCostingPanel());
