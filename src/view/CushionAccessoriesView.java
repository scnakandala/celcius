...
/*
 * CushionAccessoriesView.java
 *
 * Created on Apr 23, 2013, 1:40:03 PM
 */
 ...
 * @author naka
 */
public class CushionAccessoriesView extends JPanel {
    
    public CushionAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM CushionAccessories c");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                CushionAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                CushionAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.CushionAccessories> merged = new ArrayList<entities.CushionAccessories>(list.size());
            for (entities.CushionAccessories c : list) {
    ...
    private java.util.List<entities.CushionAccessories> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new CushionAccessoriesView());
