 ...
 * @author naka
 */
public class PillowSlipView extends JPanel {
    
    public PillowSlipView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT p FROM Pillowslips p");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                PillowSlipView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                PillowSlipView.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                PillowSlipView.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                PillowSlipView.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<entities.Pillowslips> toRemove = new ArrayList<entities.Pillowslips>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            entities.Pillowslips p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        entities.Pillowslips p = new entities.Pillowslips();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.Pillowslips> merged = new ArrayList<entities.Pillowslips>(list.size());
            for (entities.Pillowslips p : list) {
    ...
    private java.util.List<entities.Pillowslips> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PillowSlipView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new PillowSlipView());
