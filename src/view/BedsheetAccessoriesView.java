...
/*
 * BedsheetAccessoriesView.java
 *
 * Created on Apr 10, 2013, 11:43:17 PM
 */
 ...
 * @author naka
 */
public class BedsheetAccessoriesView extends JPanel {
    
    public BedsheetAccessoriesView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT b FROM BedsheetAccessories b");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                BedsheetAccessoriesView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                BedsheetAccessoriesView.this.refreshButtonActionPerformed(evt);
            }
        }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.BedsheetAccessories> merged = new ArrayList<entities.BedsheetAccessories>(list.size());
            for (entities.BedsheetAccessories b : list) {
    ...
    private java.util.List<entities.BedsheetAccessories> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new BedsheetAccessoriesView());
