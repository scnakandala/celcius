 ...
 * @author naka
 */
public class PillowProtectorView extends JPanel {
    
    public PillowProtectorView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT p FROM Pillowprotectors p");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                PillowProtectorView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                PillowProtectorView.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                PillowProtectorView.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                PillowProtectorView.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<entities.Pillowprotectors> toRemove = new ArrayList<entities.Pillowprotectors>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            entities.Pillowprotectors p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        entities.Pillowprotectors p = new entities.Pillowprotectors();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.Pillowprotectors> merged = new ArrayList<entities.Pillowprotectors>(list.size());
            for (entities.Pillowprotectors p : list) {
    ...
    private java.util.List<entities.Pillowprotectors> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PillowProtectorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new PillowProtectorView());
