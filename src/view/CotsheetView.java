 ...
 * CotsheetView.java
 *
 * Created on Apr 10, 2013, 11:27:07 PM
 */
 ...
 * @author naka
 */
public class CotsheetView extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Cotsheets c");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                CotsheetView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                CotsheetView.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                CotsheetView.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                CotsheetView.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<entities.Cotsheets> toRemove = new ArrayList<entities.Cotsheets>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            entities.Cotsheets c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        entities.Cotsheets c = new entities.Cotsheets();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.Cotsheets> merged = new ArrayList<entities.Cotsheets>(list.size());
            for (entities.Cotsheets c : list) {
    ...
    private java.util.List<entities.Cotsheets> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new CotsheetView());
