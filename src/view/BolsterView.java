 ...
 * BolsterView.java
 *
 * Created on Apr 23, 2013, 1:38:24 PM
 */
 ...
 * @author naka
 */
public class BolsterView extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT b FROM Bolsters b");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(rangeField, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                BolsterView.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                BolsterView.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                BolsterView.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                BolsterView.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<entities.Bolsters> toRemove = new ArrayList<entities.Bolsters>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            entities.Bolsters b = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(b);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        entities.Bolsters b = new entities.Bolsters();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<entities.Bolsters> merged = new ArrayList<entities.Bolsters>(list.size());
            for (entities.Bolsters b : list) {
    ...
    private java.util.List<entities.Bolsters> list;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new BolsterView());
